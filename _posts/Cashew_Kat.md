...
Cashew is a globalized plant, and particularly an international commodity crop in Ghana among other countries. 
...
A Youtube video describing the cashew botanical family and the agricultural processing requirements for cashew crops today, due to the presence of a compound called urushiol in the *Anacardiaceae* botanical family. Urushiol is a pale yellow, oily plant resin made of organic compounds called catechols.
...
{% include embed/youtube.html
    ...
    caption="Why Cashew Nuts Are So Expensive | Business Insider"
%}

Across time and space, cashew has played an important role in many human cultures and made place across diverse ecologies in its own right. 
...
{% include embed/map.html 
	...
	geojson="ph_test.geojson"
%}

Testing visualization code below: 

{% include embed/image.html id="img3" src="wc:Foto_1_Jambu_monyet_(Anacardium_occidentale).jpg" caption="*Anacardium occidentale*" aspect="4.68" %} 
...
{% include embed/image.html id="img5" src="wc:Cashew_Brazil_nut_cut.jpg" caption="Cut of a cashew shell with the fresh nut inside. The liquid visible at the cut edges is the resin from the shell. Town of Prainha near Fortaleza, Ceará, Brazil." aspect="4.68" %} 
