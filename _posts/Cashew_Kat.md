...
{% include embed/image.html id="img4" src="Cashew_Brazil_nut_cut.jpg" caption="Cut of a cashew shell with the fresh nut inside. The liquid visible at the cut edges is the resin from the shell. Town of Prainha near Fortaleza, Ceará, Brazil." aspect="4.68" %} 
