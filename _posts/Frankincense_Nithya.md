...
{% include embed/image.html id="img2" src="wc:Boswellia_sacra_-_Köhler–s_Medizinal-Pflanzen-022.jpg" caption="Franz Eugen Köhler, Köhler's Medizinal-Pflanzen,	1897, Wikimedia Commons, public domain" aspect="3.68" %}


{% include embed/image.html id="img1" src="Adoration of Magi.png" caption="Gentile da Fabriano, Uffizi Gallery,1423" aspect="2.33" %} 
